...
export function NewTransactionModal() {
  const { control, register, handleSubmit, formState: { isSubmitting } } = useForm<NewTransactionFormValues>({
  ...
  function handleCreateNewTransaction(data: NewTransactionFormValues) {
    console.log(data)
  }
